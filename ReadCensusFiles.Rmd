...
for (yr in seq(11,16)) {
  ...
  censusdf <- read.csv(filename) %>%
    select(GEO.id2, HC01_VC03, HC01_VC04, HC01_VC07, HC01_VC08, HC01_VC09, HC01_VC10, HC01_VC11, HC01_VC12, HC01_VC13, HC01_VC14, HC01_VC15, HC01_VC16, HC01_VC17, HC01_VC18, HC01_VC19, HC01_VC21, HC01_VC43, HC01_VC44, HC01_VC81 ) %>%
    filter(GEO.id2 != "Id2")
...
censusdf <- censusdf %>%
  mutate(Age25to34=Age25to29+Age30to34, 
         Age35to44=Age35to39+Age40to44, 
         Age45to54=Age45to49+Age50to54) %>%
  select(-one_of(Age25to29, Age30to34, Age35to39, Age40to44, Age45to49, Age50to54))
